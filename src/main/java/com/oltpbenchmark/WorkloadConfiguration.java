...
public class WorkloadConfiguration {
    ...
    public void addPhase(int id, int time, int warmup, int rate, List<Double> weights, List<Integer> counts, boolean rateLimited, boolean disabled, boolean serial, boolean timed, int active_terminals, Phase.Arrival arrival, boolean randomize) {
        phases.add(new Phase(benchmarkName, id, time, warmup, rate, weights, counts, rateLimited, disabled, serial, timed, active_terminals, arrival, randomize));
    }
