...
public final class Results {
    ...
    public Results(long nanoseconds, int measuredRequests, DistributionStatistics distributionStatistics, final List<Sample> latencySamples, List<Long> workerTimes) {
